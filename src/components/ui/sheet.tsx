...
function SheetOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn('app-overlay', className)}
      {...props}
    />
  );
}
...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out border-border data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
