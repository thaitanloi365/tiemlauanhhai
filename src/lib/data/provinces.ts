...
export const HCMC_PROVINCE_NAME = 'Thành phố Hồ Chí Minh';

// Địa chỉ cũ (trước đợt sắp xếp hành chính cấp tỉnh 2025): 63 tỉnh/thành.
export const PROVINCES_OLD: ProvinceOption[] = [
...
// Địa chỉ mới (sau sắp xếp hành chính cấp tỉnh 2025): 34 tỉnh/thành.
export const PROVINCES_NEW: ProvinceOption[] = [
	{ code: '01', name: 'Thành phố Hà Nội' },
	{ code: '04', name: 'Tỉnh Cao Bằng' },
	{ code: '08', name: 'Tỉnh Tuyên Quang' },
	{ code: '11', name: 'Tỉnh Điện Biên' },
